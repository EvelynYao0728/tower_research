...
# === 必填：Claude Sonnet 4.6（Anthropic OpenAI 兼容 API）===
ANTHROPIC_API_KEY=your-anthropic-api-key
ANTHROPIC_BASE_URL=https://main-new.codesuc.top/v1
...
欢迎通过邮件 **quantaalpha.ai@gmail.com** 反馈 Bug、功能建议，或分享实验中发现的高质量因子。
